...
static noinline const char *getIdentstr(unsigned *size, int small) {
    ...
    static char identbig[] =
        "\n\0"
        "$Info: "
        "THIS IS PROTECTED BY Parallax Packer $"
        "\n\0"
        "$Id: Parallax " UPX_VERSION_STRING4 " Copyright (C) 2025" UPX_VERSION_YEAR
        " the Parallax Team. All Rights Reserved. $"
        "\n";
    static char identsmall[] =
        "\n"
        "$Id: Parallax "
        "(C) 2025-" UPX_VERSION_YEAR " Parallax Packer $"
        "\n";
